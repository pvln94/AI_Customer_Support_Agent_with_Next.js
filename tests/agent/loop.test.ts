// Automated checks of the agent loop using a scripted fake AI (costs nothing) — retries, false-approval guard, injection resistance (run with `npm run test:integration`).
