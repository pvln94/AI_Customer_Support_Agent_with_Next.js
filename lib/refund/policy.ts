// LAYMAN: The refund rulebook as code — given an order it answers approve/deny/escalate (30-day window, 90 for defects, $500+ and suspended go to humans); pure math, no database, so it's unit-testable (used by the submit/eligibility tools).
