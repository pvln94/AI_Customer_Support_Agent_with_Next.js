// The agent's ID badge — carries the verified customer and request IDs into every tool so the AI can never pretend to be someone else (used by lib/agent/loop.ts and every tool).
